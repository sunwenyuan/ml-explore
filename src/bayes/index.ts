...
import { simpleTokenizer, BayesClassifier } from './bayes';
...
// Promise.all([
//     trainer('./src/bayes/data/train_positive.txt', 'positive', classifier),
//     trainer('./src/bayes/data/train_negative.txt', 'negative', classifier)
// ]).then(() => {
//     console.log("Finished training. Now testing.");

//     Promise.all([
//         tester('./src/bayes/data/test_negative.txt', 'negative', classifier),
//         tester('./src/bayes/data/test_positive.txt', 'positive', classifier)
//     ])
//         .then(results => results.reduce(
//             (obj: any, item: any) => ({ total: obj.total + item.total, correct: obj.correct + item.correct }), { total: 0, correct: 0 }
//         ))
//         .then((results: any) => {
